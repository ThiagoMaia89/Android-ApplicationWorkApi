...
import com.simplesoftware.applicationworkapi.api.RetrofitConfig
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerProducts = findViewById(R.id.recycleProducts)
        recyclerProducts.layoutManager = LinearLayoutManager(this)
        getData()
    }

    private fun getData() {
        val call: Call<List<Product>> = RetrofitConfig.instance?.productApi()?.getProductApi() as Call<List<Product>>
